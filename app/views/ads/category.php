...
<body>
                     ...
                     <div class="single-comment justify-content-between d-flex">
                        <div class="user justify-content-between d-flex">
                         ...
                         <?php if ($ad["vip"] == 1): ?>
                                ...
                                <?php echo $ad["login"] ?></li>
                                    <?php else:?>
                                     <li style="color: blue;font-size: 16px">
                                <?php echo $ad["login"] ?></li>
                         <?php endif?>                  
                             <li  style="font-size: 16px;"><?php echo $ad["data"] ?></li> 
                               <a href="/comments/index/<?php echo $ad["id"]?>"><li  style="font-size: 16px;color:black;font-weight: bold">Комментарии</li></a>
                               </ul>
                                 </div>
                                    <div>
                                  </div>
  ...
  <aside class="single_sidebar_widget post_category_widget">
    ...
    $url = $_SERVER['REQUEST_URI'];
		...
		$a = 1;					  
    ?>
      <div style="text-align:center;font-size:26px;padding-bottom:20px">   
     <?php for($a=1;$a<=ceil($ads["count_total"]/$qty_content);$a++):?>
     <?php if ($str == $a):?>
   <a href="?page=<?php echo $a ?>" style="color:blue;text-decoration:underline"><?php echo $a ?></a>
   <?php else:?>
